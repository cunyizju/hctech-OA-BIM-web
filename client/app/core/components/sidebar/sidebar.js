...
! function ($) {
	...
	let sidebar = function (element, options) {
	...
	sidebar.prototype.toggleSub = function (toggle) {
		...
		let toggleParent = toggle.parent();
		let subMenu = toggleParent.find("> ul");
		let opened = toggleParent.hasClass("open");
	...
	$(".sidebar").each(function () {
		...
		let cursidebar = new sidebar(this, options);
	});
